...
#features_list = ['poi', "fraction_to_poi", 'restricted_stock', "salary", "bonus", "total_stock_value", 'exercised_stock_options'] # You will need to use more features
#features_list = ['poi', "fraction_to_poi", 'restricted_stock', "expenses", 'deferred_income', "bonus", "salary", "total_stock_value", 'exercised_stock_options']
