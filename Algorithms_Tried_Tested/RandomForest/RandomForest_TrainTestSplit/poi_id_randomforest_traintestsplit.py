...
features_list = ['poi', "fraction_to_poi", 'salary', 'deferral_payments', 'total_payments', 'bonus', 'deferred_income', 'total_stock_value', 'expenses', 'exercised_stock_options', 'other', 'long_term_incentive', 'restricted_stock' ] # You will need to use more features
...
#clf = RandomForestClassifier(min_samples_split = 2, criterion = 'gini', max_depth = 6, n_estimators = 7, random_state = 41)
